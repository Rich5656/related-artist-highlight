...
const AUTH_URL = 'https://accounts.spotify.com/authorize?client_id=f124335254b9413f9008b34cb5f1b4c9&response_type=code&redirect_uri=https://related-artist-highlight.netlify.app/&scope=user-top-read'; 

export const Login = () => {
  return (
    <>
      <Container className='d-flex-column justify-content-center align-items-center main-style fade-in' style={{ minHeight: '100vh' }}>
